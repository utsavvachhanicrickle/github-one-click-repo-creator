...
export default function PersonalStoreList() {
  ...
  // Admin hasn't connected GitHub yet
    ...
    return (
      <div className="max-w-2xl mx-auto px-6 py-24 text-center select-none relative z-10">
        ...
        <p className="text-sm text-(--text-secondary) leading-relaxed max-w-lg mx-auto font-medium">
          Your administrator hasn't linked their GitHub account yet. Store repository management and sync tools will be available once your admin connects their GitHub profile.
        </p>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto px-6 mt-12 relative z-10">
        ...
        <section className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8 select-none">
          <div>
            ...
            <p className="text-xs text-(--text-secondary) mt-1.5 font-semibold">
              View and manage stores assigned to your profile.
            </p>
          </div>
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20 text-(--text-secondary) gap-3 select-none">
            ...
            <span className="font-extrabold text-sm">Loading store repositories...</span>
          </div>
        ) : error ? (
          ...
          <div className="border-2 border-dashed border-(--border) rounded-3xl p-16 text-center text-(--text-secondary) bg-(--bg-primary)/40 select-none">
            ...
            <p className="text-xs mt-1">
              {searchQuery ? `No matches found for "${searchQuery}".` : 'You have not created or been assigned any stores yet.'}
            </p>
          </div>
        )}
      </div>
